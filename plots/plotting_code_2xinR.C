...
NonLinearity_TEPXClustersPerEvent[1][3][0]->SetLineColor(2);
 ...
 //NonLinearity_TEPXClustersPerEvent[1][3][0]->SetTitle("Side 2 Disk 4 Ring 1 (L1L2 & L3L4)");
 ...
 C1.Print(outputpath3 + "NS2Brane2xinR.gif");
 C1.Clear();
...
NonLinearity_TEPXClustersPerEvent[s][d][0]->SetTitle(TString("Disk ") + (d + 1) + TString(" Side ") + (s + 1) + TString(" "));
